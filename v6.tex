...
% --- DT feature importances (required) ---
\begin{figure}[htbp]
...
% --- per-model Hotel diagnostic figures removed to save space ---
\begin{table}[htbp]
...
% Removed per-model kNN, Linear SVM, and RBF SVM diagnostic panels for \datasetB{}

\begin{comment}
Per-model NN diagnostics (Accidents) removed.
\end{comment}
