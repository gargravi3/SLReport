...
Table~\ref{tab:hotel-metrics} reports test-set metrics and thresholds (calibrated models). DT and KNN provide strong calibrated precision–recall trade-offs; RBF-SVM underperforms and is costly.
...
NN (cal) & 0.7941 & 0.7077 & 0.7565 & 0.7313 & 0.8737 & 0.8397 & 0.50 & 0.1401 \\
\hline
\end{tabular}
...
\end{minipage}
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/hotel/threshold_metrics_decision_tree_calibrated.png}
\end{minipage}
\caption{\datasetA{}: Decision Tree diagnostics — (a) ROC, (b) PR, (c) Reliability, (d) Precision/Recall/F1 vs threshold.}
\end{figure}

\begin{figure}[htbp]
\centerline{\maybeincludegraphics[width=0.9\linewidth]{figures/hotel/confusion_matrix_decision_tree_calibrated.png}}
\caption{\datasetA{}: Confusion matrix at chosen threshold (DT).}
\end{figure}
...
\begin{figure}[htbp]
\centerline{\maybeincludegraphics[width=0.95\linewidth]{figures/hotel/decision_tree_structure.png}}
\caption{\datasetA{}: Decision tree structure (depth-3 view).}
\end{figure}
...
\centering
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/hotel/roc_curve_knn_calibrated.png}
\end{minipage}
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/hotel/pr_curve_knn_calibrated.png}
\end{minipage}
\vspace{2pt}
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/hotel/calibration_curve_knn_calibrated.png}
\end{minipage}
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/hotel/confusion_matrix_knn_calibrated.png}
\end{minipage}
\caption{\datasetA{}: kNN diagnostics — (a) ROC, (b) PR, (c) Reliability, (d) Confusion matrix at chosen threshold.}
\end{figure}

\begin{figure}[htbp]
\centering
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/hotel/roc_curve_linear_svm_liblinear_calibrated.png}
\end{minipage}
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/hotel/pr_curve_linear_svm_liblinear_calibrated.png}
\end{minipage}
\vspace{2pt}
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/hotel/calibration_curve_linear_svm_liblinear_calibrated.png}
\end{minipage}
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/hotel/confusion_matrix_linear_svm_liblinear_calibrated.png}
\end{minipage}
\caption{\datasetA{}: Linear SVM (liblinear) diagnostics — (a) ROC, (b) PR, (c) Reliability, (d) Confusion matrix at chosen threshold.}
\end{figure}

\begin{figure}[htbp]
\centering
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/hotel/roc_curve_rbf_svm_calibrated.png}
\end{minipage}
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/hotel/pr_curve_rbf_svm_calibrated.png}
\end{minipage}
\vspace{2pt}
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/hotel/calibration_curve_rbf_svm_calibrated.png}
\end{minipage}
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/hotel/confusion_matrix_rbf_svm_calibrated.png}
\end{minipage}
\caption{\datasetA{}: RBF SVM diagnostics — (a) ROC, (b) PR, (c) Reliability, (d) Confusion matrix at chosen threshold.}
\end{figure}

\begin{figure}[htbp]
\centering
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/hotel/roc_curve_nn_calibrated.png}
\end{minipage}
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/hotel/pr_curve_nn_calibrated.png}
\end{minipage}
\vspace{2pt}
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/hotel/calibration_curve_nn_calibrated.png}
\end{minipage}
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/hotel/confusion_matrix_nn_calibrated.png}
\end{minipage}
\caption{\datasetA{}: NN diagnostics — (a) ROC, (b) PR, (c) Reliability, (d) Confusion matrix at chosen threshold.}
\end{figure}
...
DT (cal) & 143.69 & 0.17 \\
 kNN (cal) & 94.23 & 2.95 \\
 Linear SVM (cal) & 12.29 & 0.03 \\
 RBF SVM (cal) & 2917.71 & 10.11 \\
 NN (cal) & 71.50 & 0.07 \\
\hline
\end{tabular}
\end{center}
...
\centering
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/accidents/roc_curve_knn_calibrated.png}
\end{minipage}
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/accidents/pr_curve_knn_calibrated.png}
\end{minipage}
\vspace{2pt}
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/accidents/calibration_curve_knn_calibrated.png}
\end{minipage}
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/accidents/confusion_matrix_knn_calibrated.png}
\end{minipage}
\caption{\datasetB{}: kNN diagnostics — (a) ROC, (b) PR, (c) Reliability, (d) Confusion matrix at chosen threshold.}
\end{figure}

\begin{figure}[htbp]
\centering
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/accidents/roc_curve_linear_svm_sgd_calibrated.png}
\end{minipage}
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/accidents/pr_curve_linear_svm_sgd_calibrated.png}
\end{minipage}
\vspace{2pt}
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/accidents/calibration_curve_linear_svm_sgd_calibrated.png}
\end{minipage}
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/accidents/confusion_matrix_linear_svm_sgd_calibrated.png}
\end{minipage}
\caption{\datasetB{}: Linear SVM (SGD) diagnostics — (a) ROC, (b) PR, (c) Reliability, (d) Confusion matrix at chosen threshold.}
\end{figure}

\begin{figure}[htbp]
\centering
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/accidents/roc_curve_rbf_svm_calibrated.png}
\end{minipage}
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/accidents/pr_curve_rbf_svm_calibrated.png}
\end{minipage}
\vspace{2pt}
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/accidents/calibration_curve_rbf_svm_calibrated.png}
\end{minipage}
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/accidents/confusion_matrix_rbf_svm_calibrated.png}
\end{minipage}
\caption{\datasetB{}: RBF SVM diagnostics — (a) ROC, (b) PR, (c) Reliability, (d) Confusion matrix at chosen threshold.}
\end{figure}

\begin{figure}[htbp]
\centering
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/accidents/roc_curve_nn_calibrated.png}
\end{minipage}
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/accidents/pr_curve_nn_calibrated.png}
\end{minipage}
\vspace{2pt}
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/accidents/calibration_curve_nn_calibrated.png}
\end{minipage}
\begin{minipage}{0.49\linewidth}
\maybeincludegraphics[width=\linewidth]{figures/accidents/confusion_matrix_nn_calibrated.png}
\end{minipage}
\caption{\datasetB{}: NN diagnostics — (a) ROC, (b) PR, (c) Reliability, (d) Confusion matrix at chosen threshold.}
\end{figure}
...
Model & Fit (s) & Predict (s) \\
\hline
DT (cal) & 2197.59 & 16.26 \\
 Linear SVM (SGD, cal) & 32.42 & 3.03 \\
 NN (cal) & 357.52 & 5.26 \\
\hline
\end{tabular}
\end{center}
\vspace{2pt}\footnotesize KNN and RBF SVM omitted due to runtime constraints on full test set; see text for details.
\end{table}
...
\bibitem{platt1999} J. Platt, ``Probabilistic Outputs for Support Vector Machines,'' 1999.
\bibitem{davis2006} J. Davis and M. Goadrich, ``The Relationship Between Precision-Recall and ROC Curves,'' ICML 2006.
\bibitem{niculescu2005} A. Niculescu-Mizil and R. Caruana, ``Predicting Good Probabilities with Supervised Learning,'' ICML 2005.
\bibitem{breiman2001} L. Breiman, ``Random Forests,'' Machine Learning, 2001.
\end{thebibliography}
