...
\begin{table}[htbp]
\caption{Test-set metrics on \datasetA{} (calibrated; thresholds from validation).}
\begin{center}
\begin{tabular}{|l|r|r|r|r|r|r|r|}
\hline
Model & Acc & Prec & Rec & F1 & ROC & PR & Brier \\
\hline
DT (cal) & 0.8660 & 0.8146 & 0.8265 & 0.8205 & 0.9434 & 0.9176 & 0.0927 \\
kNN (cal) & 0.8402 & 0.8382 & 0.7047 & 0.7657 & 0.9060 & 0.8833 & 0.1121 \\
LinSVM (cal) & 0.8115 & 0.7413 & 0.7543 & 0.7477 & 0.8882 & 0.8446 & 0.1275 \\
RBF SVM (cal) & 0.4676 & 0.4020 & 0.8967 & 0.5551 & 0.6152 & 0.4796 & 0.2240 \\
NN (cal) & 0.7941 & 0.7077 & 0.7565 & 0.7313 & 0.8737 & 0.8397 & 0.1401 \\
\hline
\end{tabular}
...
\begin{figure}[htbp]
\centerline{\maybeincludegraphics[width=0.95\linewidth]{figures/hotel/complexity_curve_clf__max_depth_decision_tree_max_depth.png}}
\caption{\datasetA{}: Model-complexity (DT: max\_depth).}
\end{figure}

\begin{figure}[htbp]
\centerline{\maybeincludegraphics[width=0.95\linewidth]{figures/hotel/complexity_curve_clf__n_neighbors_knn_n_neighbors.png}}
\caption{\datasetA{}: Model-complexity (kNN: $k$).}
\end{figure}

\begin{figure}[htbp]
\centerline{\maybeincludegraphics[width=0.95\linewidth]{figures/hotel/complexity_curve_clf__C_linear_svm_C.png}}
\caption{\datasetA{}: Model-complexity (Linear SVM: $C$).}
\end{figure}

\begin{figure}[htbp]
\centerline{\maybeincludegraphics[width=0.95\linewidth]{figures/hotel/complexity_curve_clf__alpha_nn_alpha.png}}
\caption{\datasetA{}: Model-complexity (NN: L2 $\alpha$).}
\end{figure}

% Diagnostics
\begin{figure}[htbp]
\centerline{\maybeincludegraphics[width=0.95\linewidth]{figures/hotel/roc_curve_decision_tree_calibrated.png}}
\caption{\datasetA{}: ROC (DT calibrated).}
\end{figure}

\begin{figure}[htbp]
\centerline{\maybeincludegraphics[width=0.95\linewidth]{figures/hotel/pr_curve_decision_tree_calibrated.png}}
\caption{\datasetA{}: PR (DT calibrated).}
\end{figure}

\begin{figure}[htbp]
\centerline{\maybeincludegraphics[width=0.9\linewidth]{figures/hotel/calibration_curve_decision_tree_calibrated.png}}
\caption{\datasetA{}: Reliability (DT calibrated).}
\end{figure}

\begin{figure}[htbp]
\centerline{\maybeincludegraphics[width=0.9\linewidth]{figures/hotel/threshold_metrics_decision_tree_calibrated.png}}
\caption{\datasetA{}: Precision/Recall/F1 vs threshold (DT).}
\end{figure}
...
\begin{table}[htbp]
\caption{Test-set metrics on \datasetB{} (calibrated; thresholds from validation).}
\begin{center}
\begin{tabular}{|l|r|r|r|r|r|r|r|}
\hline
Model & Acc & Prec & Rec & F1 & ROC & PR & Brier \\
\hline
DT (cal) & 0.8737 & 0.6603 & 0.7230 & 0.6903 & 0.9107 & 0.7508 & 0.0871 \\
kNN (cal) & 0.7729 & 0.3993 & 0.3309 & 0.3619 & 0.6932 & 0.3473 & 0.1448 \\
LinSVM (SGD, cal) & 0.6288 & 0.2978 & 0.6681 & 0.4120 & 0.6877 & 0.3236 & 0.1463 \\
RBF SVM (cal) & 0.3832 & 0.2167 & 0.8296 & 0.3436 & 0.5856 & 0.2432 & 0.1546 \\
NN (cal) & 0.6859 & 0.3388 & 0.6452 & 0.4443 & 0.7324 & 0.3698 & 0.2125 \\
\hline
\end{tabular}
...
% Diagnostics (DT shown)
\begin{figure}[htbp]
\centerline{\maybeincludegraphics[width=0.95\linewidth]{figures/accidents/roc_curve_decision_tree_calibrated.png}}
\caption{\datasetB{}: ROC (DT calibrated).}
\end{figure}

\begin{figure}[htbp]
\centerline{\maybeincludegraphics[width=0.95\linewidth]{figures/accidents/pr_curve_decision_tree_calibrated.png}}
\caption{\datasetB{}: PR (DT calibrated).}
\end{figure}

\begin{figure}[htbp]
\centerline{\maybeincludegraphics[width=0.9\linewidth]{figures/accidents/calibration_curve_decision_tree_calibrated.png}}
\caption{\datasetB{}: Reliability (DT calibrated).}
\end{figure}

\begin{figure}[htbp]
\centerline{\maybeincludegraphics[width=0.9\linewidth]{figures/accidents/confusion_matrix_decision_tree_calibrated.png}}
\caption{\datasetB{}: Confusion matrix at chosen threshold (DT).}
\end{figure}
